...
import { Home, Outschool, Portfolio, ProfessionPupils, ProfessionTeachers, Projects, NotFound, CreateLesson, UpdateLesson, UpdatePost } from './pages/index'
    ...
    <div className='d-flex flex-column h-100'>
     ...
     <main className='mt-3 mb-3'>
      <Routes>
        ...
        <Route path='/admin/updatelesson' element={<UpdateLesson />} />
        <Route path='/admin/updatepost' element={<UpdatePost />} />
